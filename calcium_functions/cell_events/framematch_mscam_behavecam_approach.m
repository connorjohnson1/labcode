function[cellfreq, startstopframes, totaltime] = framematch_mscam_behavecam_approach(approach, behavior, cell_events, timestamp)
...
%interating, we look at a range of time with t0 being when the interaction
%starts, and the end time being the number of seconds input by the variable
%"approach".
%
%INPUTS:
%
%Approach = How many seconds you want to look at after an interaction
%starts.
%
