function[cellfreq, startstopframes, totaltime] = framematch_mscam_behavecam_neg_approach(approach, behavior, cell_events, timestamp)
...
%interating, we look at a range of time from -n seconds before t0
%(interaction starts). n = approach.
%
%INPUTS:
%
%Approach = How many seconds you want to look at before an interaction
%starts.
%
